...
[![Codecov test coverage](https://codecov.io/gh/rstudio/connectapi/branch/master/graph/badge.svg)](https://codecov.io/gh/rstudio/connectapi?branch=master)
...
This is likely due to either (1) `Connect$host` or `Connect$api_key` being
defined improperly or (2) you do no thave access to the RStudio Connect cluster
