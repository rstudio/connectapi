...
Thanks for using connectapi. Before filing an issue, there are a few places
...
Armed with your reprex, the next step is to figure out [where to ask](https://www.tidyverse.org/help/#where-to-ask). 
  ...
  * If it's a question: start with
    [community.rstudio.com](https://community.rstudio.com/c/r-admin/rstudio-connect/),
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/connectapi/issues) to make sure the 
